...
\midrule
Đăng nhập & \endpoint{POST}{/vulnerable/auth/login} & \endpoint{POST}{/secure/auth/login}\\
Xem user & \endpoint{GET}{/vulnerable/users/\{id\}} & \endpoint{GET}{/secure/users/me}\\
Cập nhật user & \endpoint{PATCH}{/vulnerable/users/me} & \endpoint{PATCH}{/secure/users/me}\\
Tìm kiếm product & \endpoint{GET}{/vulnerable/products/search} & \endpoint{GET}{/secure/products/search}\\
Xem order & \endpoint{GET}{/vulnerable/orders/\{id\}} & \endpoint{GET}{/secure/orders/\{id\}}\\
Payment callback & \endpointthree{POST}{/vulnerable/payments/}{preview-callback} & \endpointthree{POST}{/secure/payments/}{preview-callback}\\
\bottomrule
\end{longtable}
